...
const CAPS: { name: string; level: string; tone: string }[] = [
  ...
  { name: "Interval timelapse (frames + MP4 bake)", level: "Possible now", tone: C.go },
  ...
  { name: "Green-screen video keying, baked into export", level: "Possible now", tone: C.go },
  { name: "Animated GIF frames in a baked export", level: "First frame only", tone: C.device },
  ...
  { name: "Auto lock — snapshot the surface itself as the tracker", level: "Possible now", tone: C.go },
  { name: "Default camera app / camera intents (IMAGE_CAPTURE etc.)", level: "Possible now", tone: C.go },
  { name: "Claim the double-press-power gesture", level: "OS decides, not the app", tone: C.native },
