...
| **Lab** | ✅ Works | Live viewfinder with real overlay guides + look tints, **plus on-device colour-palette analysis** (capture a frame → dominant/vibrant/muted swatches, via react-native-image-colors). Deeper GPU pixel analysis (edge/motion/stacking) is Phase 6. |
